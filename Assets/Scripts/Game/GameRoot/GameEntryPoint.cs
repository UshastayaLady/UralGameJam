...
public class GameEntryPoint
{
    ...
    private GameEntryPoint()
    {
        ...
        _achievementManager = new GameObject("[ACHIEVEMENTS]").AddComponent<AchievementManager>();
        Object.DontDestroyOnLoad(_achievementManager.gameObject);
        _achievementManager.Initialize();

        _saveManager = new GameObject("[SAVE_MANAGER]").AddComponent<SaveManager>();
    ...
    private IEnumerator LoadAndStartMainMenu()
    {
        ...
        sceneEntryPoint.OnLoadGameplayScene += (() => _coroutine.StartCoroutine(LoadAndStartGameplay()));
